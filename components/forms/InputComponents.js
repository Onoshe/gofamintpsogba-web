...
const InputComponent = ({title, type, name, value, onChange, pholder, required, contStyle, titleStyle, inputStyle, noWidth}) => {
  return (
...
export {InputComponent, TextAreaInputComponent, RadioInputComponent, SelectionTag}