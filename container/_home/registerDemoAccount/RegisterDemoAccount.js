...
const RegisterDemoAccount = ({viewPwd, handleViewPwd, form, handleOnChange, handelRegister, setShowBlind, loadingMsg, showBlind}) => {
...
export default RegisterDemoAccount;
