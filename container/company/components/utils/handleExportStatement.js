...
export const handleExportStatement = async ({imgObj, pdfData= pdfDataDef}) => {
    ...
    //Upper table Lines- uT and and string
        ...
        doc.text("Statement Period from "+new Date().toDateString()+" to "+new Date().toDateString(), pageWidth/2, l2Y);
        doc.setTextColor('black');
        doc.setFont("times", "normal");

        let headData = ["SN", "Date", "Transaction details", "Reference", "Amount", "Balance"];
        ...
        doc.autoTable({
          ...
          // Sample data for the table
            ...
            for (var i = 0; i < 1000; i++) {
                data.push([i+1+'.', new Date().toLocaleDateString(), "Data display in row " + (i + 1), "More data", 1000 * i, 1000 * i]);
            }
        ...
        let foot = [[{content:"   ", colSpan:5}, { content: "Confidential", styles: { halign: 'center', fontSize:9, fillColor:"red",} }], 
            ...
            [{ content: pdfData.companyContact, colSpan: 6, styles: { halign: 'center', fontSize:9 } }]
            ];
...
var pdfDataDef = {
    ...
    author:'Sunday Adegboye',
    keywords:'kosofe, cooperative, adesung,  web 2.0, ajax',
  };

  function getAccountDetails(pdfData){
    const style1 = {halign:"left", cellPadding:{bottom:2, left:2}};
    ...
    return [
        [{content: "Account Name", styles:style1}, {content: pdfData.accountName, styles:style1},
         ...
         {content: "James1", styles:styleBlank},{content: "Ali 1", styles:styleBlank},
         {content: "Opening balance", styles:style1}, {content: pdfData.openingBalance, styles:style1},
        ],
        [{content: "Account Number", styles:style1}, {content: pdfData.accountNo, styles:style1},
            {content: "James1", styles:styleBlank},{content: "Ali 1", styles:styleBlank},
             {content: "James1", styles:styleBlank},{content: "Ali 1", styles:styleBlank},
            {content: "Total debits", styles:style1}, {content: pdfData.totalDebits, styles:style1},
        ],
        [{content: "Account Type", styles:style1}, {content: "Savings", styles:style1},
            {content: "James1", styles:styleBlank},{content: "Ali 1", styles:styleBlank},
            {content: "James1", styles:styleBlank},{content: "Ali 1", styles:styleBlank},
            {content: "Total credits", styles:style1}, {content: pdfData.totalCredits, styles:style1},
        ],
        [{content: "Currency", styles:style1}, {content: pdfData.currency, styles:style1},
            {content: "James1", styles:styleBlank},{content: "Ali 1", styles:styleBlank},
            {content: "James1", styles:styleBlank},{content: "Ali 1", styles:styleBlank},
            {content: "Closing balance", styles:style1}, {content: pdfData.closingBalance, styles:style1},
        ],
    ]
  }