   ...
   //console.log(products)
    ...
    <PageBlind showBlind={showBlind}>
        <div className={`w-full justify-center items-center flex flex-col`}>
            <div className='w-full max-w-[700px] justify-center flex flex-col bg-white boxShadowWhite99 text-gray-900'>
                    ...
                    <div className='p-3 smc:px-5 gap-4 flex flex-col'>
                        <div className='flex flex-row items-center gap-3 flex-wrap'>
                            <Selection
                                ...
                                classNameLabel={'whitespace-nowrap w-[140px] text-red-600 mr-2'}
                            ...
                            {(!formInput.category) && 
                                <TextInput
                                    ...
                                    classNameLabel={'whitespace-nowrap text-red-600 mr-2 hidden'}
                                    classNameInput={''}
