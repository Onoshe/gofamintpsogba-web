...
import { handleCreateClientAccountOnly } from '@/container/admin/utils/handleCreateClientAccountOnly';



const CreateAccount = ({clientsData, handleRevalidate}) => {
   ...
   const handleSubmit = async (e)=>{
        e.preventDefault();
       await handleCreateClientAccountOnly(form, alert, setAlert, handleRevalidate)
  ...
  return (
    <div className='p-4 w-full'>
        <div className='flex flex-col w-full'>
                <BackgroundCard
                    title={"Create Client Account (No database Tables created)"}
