...
const TransactionsEntriesView = ({transSheet, chartOfAccounts, personalAccts, showTransView, closeTransView}) => {
 ...
 return (
    <div className={`mr-3 text-sm shadow-lg bg-[#f9fff9] shadow-green-100 xlc:mt-4 max-w-[800px] xlc:max-w-[300px] 2xl:max-w-[400px] p-3 border border-green-400 ${showTransView? '' : 'hidden'}`}>
