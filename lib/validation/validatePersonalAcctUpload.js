...
function validateAndFormatPersonalAcct(forms, personalAccount, personalAccountType) {
    ...
    if(!type || !title || !firstname || !accountCode || !lastname){
      return {
        error: true,
        errorType: 'REQUIRED_VALUE',
        rowIndex: i,
        key:'type, title, firstname, lastnane and accountCode'
