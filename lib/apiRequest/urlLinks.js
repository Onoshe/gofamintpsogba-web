...
export function getLinkFetchTableWithConds({table, conds, values}){
    const domainNomal = table.split("_")[0];
...
export function getLinksAdmin(domain){
    ...
    return {usersAccountUrl, clientsDataUr, accessDataUrl, dbTablesUrl, accessUrl, subscriptionsUrl, settingsUrl, backupUrl, databasesUrl}
}
